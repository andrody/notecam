...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public int createSubjectAndClasses(Subject subject, List<Class> classes){
        long subject_id = createSubject(subject);
        if(classes != null)
            createClasses(classes, subject_id);
        return (int)subject_id;
    }

    public void updateSubjectAndClasses(Subject subject, List<Class> classes){
        updateSubject(subject);
        deleteAllClassesBySubject(subject.getId());
        createClasses(classes, subject.getId());
        //closeDB();
    }
    ...
    * Creating class
    */
    private long createClass(Class cl, long subject_id) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    private void createClasses(List<Class> classes, long subject_id){
    ...
    * Updating a class
    */
    private int updateClass(Class cl) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    */
    public List<Class> getAllClassesBySubject(long subject_id) {
